...
- Базовий рівень `shopify theme check` на стоковій темі: 6 errors / 2 warnings у 5 файлах (`collection-links`, `header`, `main-cart`, `product-list`, `bento-grid`). Рахуємо лише приріст відносно цього рівня.
